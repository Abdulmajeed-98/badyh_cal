...
class FormsScreen extends StatelessWidget {
  late Pages p;
  late String id;
  FormsScreen({super.key, required this.p});
  PagesVM pvm = PagesVM();
                            ...
                            return SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, i) => InkWell(
                                  onTap: () => Navigator.pushNamed(ctx, '/${snapshot.data![i].title}',
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: Colors.green,
                                              image: DecorationImage(image: NetworkImage(snapshot.data![i].mainImage!),fit: BoxFit.fill),
